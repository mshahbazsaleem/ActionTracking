...
namespace MAA.ActionTracking.Web.Models
{
    ...
    public class GridDataViewModel<T>
    {
        /// <summary>
    ...
    public class GridViewModel
    {
        ...
        public string SortOrder => Columns != null && Order != null && Order.Length > 0
                    ? (Columns[Order[0].Column].Data + (Order[0].SortDirection == OrderDir.DESC ? " " + Order[0].Dir : string.Empty))
                    : null;
    ...
    public class Order
    {
        ...
        public OrderDir SortDirection
        {
            get
            {
                ...
                return Dir.Equals("asc") ? OrderDir.ASC : OrderDir.DESC;
            }
        }
    }
